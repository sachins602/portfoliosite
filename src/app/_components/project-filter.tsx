...
export function ProjectFilter({
	...
	return (
		<div className="mb-8 space-y-6">
			{/* Languages */}
			<div>
				<h3 className="mb-3 font-semibold text-sm text-[var(--text-secondary)]">
					Languages
				</h3>
			...
			{hasActiveFilters && (
				<button
					className="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--bg-secondary)] px-4 py-2 text-sm text-[var(--text-secondary)] transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)]"
